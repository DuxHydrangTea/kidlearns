...
@section('content')
    ...
    <form class="container mx-auto px-4 py-8">
        <h1>Chọn học sinh để kiểm tra</h1>
        <select name="user_id" id="" class="px-6 py-3 rounded-lg border border-gray-300 mb-6 w-full max-w-xs">
        ...
        <button class="px-5 py-3 bg-blue-600 text-white rounded-lg">Tra cứu</button>
    </form>

    <div class="container mx-auto px-4 py-8">
        <div class="text-xl font-extrabold mb-8 text-blue-700 text-center tracking-tight flex gap-[30px]">
        ...
        <div tab="exams" class="bg-white shadow-xl rounded-2xl p-6 overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="py-6 px-4 text-center text-gray-400 italic">Người này chưa có lịch sử làm kiểm tra nào.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div tab="progress" class="grid grid-cols-4 gap-6 mt-8">
            @forelse ($lessonProgresses as $lessonProgress )
            @php
            ...
            @endphp
                ...
                @empty
                    <div class="col-span-4 text-center text-gray-400 italic">Người này chưa có tiến trình học nào.</div>
                @endforelse
