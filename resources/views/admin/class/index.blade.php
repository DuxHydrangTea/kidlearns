...
<div class="bg-white rounded-lg shadow-sm">
    <div class="flex items-center justify-between p-4 border-b">
        <h1 class="text-2xl font-semibold">Quản lý lớp học</h1>
                    ...
                    <tr>
                        <td class="px-4 py-3">
                            <div class="flex items-center">
                                {{-- <img src="{{ asset($class->thumbnail) }}" alt="{{ $class->name }}" class=" rounded-full"> --}}
                            </div>
                        </td>
                        <td class="px-4 py-3">
                            <div class="flex items-center">
                        ...
                        <td class="px-4 py-3 text-sm text-gray-500">{{ $class->created_at->format('d/m/Y') }}</td>
                        <td class="px-4 py-3 text-sm">
                            <div class="flex items-center space-x-2">
                                <a href="{{ route('admin.classes.edit', $class->id) }}" class="text-blue-600 hover:text-blue-800">
